  ...
  <v-container v-if="local" class="pt-0">
    ...
    <v-row class="relative mb-7 mt-n6">
      <v-col class="pa-0">
        ...
        >
          <v-img :src="local.Portada" class="cover-page-menu" height="280">
            <div class="gradient-carta" v-scr>
              ...
              <div class="name-menu px-3">
                <v-row>
                  <v-col cols="1" class="pt-2 d-none button-back">
                    <v-icon @click="$router.back()" color="#000" class="ml-n2">mdi-chevron-left</v-icon>
                  </v-col>
                  <v-col class="pt-1 description-menu">
                    <h2 class="title title-name-menu white--text">{{ local.Nombre }}</h2>
                    <v-list-item-subtitle class="white--text adress-menu">{{ local.Direccion }}</v-list-item-subtitle>
                  </v-col>
                </v-row>
              </div>
            </div>
